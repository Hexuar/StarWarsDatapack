...
# Ship Data
data modify storage starwars:ships a_wing set value {max_speed:100, acceleration:4, rotational_speed:2, height:1.5}
...
data modify storage starwars:ships x_wing set value {max_speed:140, acceleration:4, rotational_speed:2, height:1}
