execute as @e[type=!marker,dx=0,dy=0,dz=0] positioned ~-1 ~-1 ~-1 as @s[dx=0,dy=0,dz=0] run function starwars:entity/blaster_bolt/hit with entity @e[type=marker,tag=starwars.blaster_bolt,sort=nearest,limit=1] data
