# Root Entity
summon villager ~ ~ ~ {CustomNameVisible:0b,Tags:["starwars.new","starwars.entity","starwars.entity_root","starwars.mob","starwars.jawa"],CustomName:{"translate":"entity.starwars.jawa"},active_effects:[{id:"minecraft:invisibility",amplifier:1,duration:-1,show_particles:0b}],VillagerData:{"profession":"armorer",level:99},DeathLootTable:"starwars:entities/jawa"}
