# Root Entity
summon husk ~ ~ ~ {CustomNameVisible:0b,Tags:["starwars.new","starwars.entity","starwars.entity_root","starwars.mob","starwars.darth_jar_jar"],CustomName:{"translate":"entity.starwars.darth_jar_jar"},active_effects:[{id:"minecraft:invisibility",amplifier:1,duration:-1,show_particles:0b}],DeathLootTable:"starwars:entities/darth_jar_jar",Health:50,attributes:[{id:"max_health",base:50}]}
