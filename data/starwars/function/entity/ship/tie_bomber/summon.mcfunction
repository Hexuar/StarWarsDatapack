...
execute as @n[type=item_display,tag=starwars.new] run data modify entity @s item.components."minecraft:custom_data".starwars.ship set from storage starwars:ships tie_bomber
