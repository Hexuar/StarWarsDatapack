...
execute if score #lit starwars.value matches 0 run item modify entity @s weapon {"function":"minecraft:set_custom_model_data","flags":{"values":[false],"mode":"replace_section"}}
execute if score #lit starwars.value matches 1 run item modify entity @s weapon {"function":"minecraft:set_custom_model_data","flags":{"values":[true],"mode":"replace_section"}}