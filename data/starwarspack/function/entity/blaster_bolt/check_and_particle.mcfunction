...
execute unless block ~ ~ ~ #starwarspack:transparent run function starwarspack:entity/blaster_bolt/hit with entity @e[type=marker,tag=starwarspack.blaster_bolt,sort=nearest,limit=1] data
