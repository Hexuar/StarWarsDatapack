...
# Rotation
$execute store result storage starwarspack:input rx int 1 run random value -$(bloom)..$(bloom)
$execute store result storage starwarspack:input ry int 1 run random value -$(bloom)..$(bloom)
